...
__ARIMAPY_LOGGING_SETUP: bool = False
...
def setup_logging(level: str = "INFO") -> None:
    """Globally configure logging for all modules under ARIMAPY.
    ...
    """
    global __ARIMAPY_LOGGING_SETUP

    with __LOCK:
        if not __ARIMAPY_LOGGING_SETUP:
            format = (
